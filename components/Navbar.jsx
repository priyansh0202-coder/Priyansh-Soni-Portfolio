...
const Navbar = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full flex justify-center z-50 transition-all duration-300 ease-in-out">
            <div
                className={`flex items-center gap-4 justify-center w-full transition-all duration-300 ease-in-out 
                    px-4 md:px-12 md:py-2 mt- md:mt-4 rounded-sm  
                    gap-20 
                    ${isExpanded ? "max-w-[800px] " : "max-w-[500px]  bg-white/20 backdrop-blur-md "}`}
            >
                {/* Logo */}
                {/* <div className="flex items-center gap-2">
                    <Image
                        src="/assets/logo-upzyne.webp"
                        alt="Upzyne Logo"
                        width={150}
                        height={63}
