...
function Herosection() {
    return (
        <section className="relative overflow-hidden bg-black text-white">
            ...
            {/* Content */}
            <div className="relative z-10 container mx-auto px-4 py-16 md:py-4 text-center">
                {/* Circular Photo + Verified */}
                <div className="flex flex-col items-center mb-6">
                    <Image
                        src={Photo} // Replace with your profile photo path
                        alt="Priyansh Soni"
                        width={150}
                        height={150}
                ...
                {/* <div className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-pink-400 opacity-30 rounded-full blur-[180px] -translate-x-1/3 -translate-y-1/2 z-0" /> */}
                {/* Name */}
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-white to-[#ffb647] text-transparent bg-clip-text font-serif">
                    Hi I'm Priyansh Soni
                </h1>

                {/* Typewriter */}
                <h2 className="text-xl md:text-3xl font-bold mb-6 text-white bg-clip-text text-transparent">
                    <Typewriter
                        words={['Full Stack Developer', "Problem Solver", "Performance Optimizer"]}
                        loop
                        cursor
                ...
                {/* Description */}
                <p className="text-base md:text-lg text-muted-foreground mb-10 px-4 max-w-4xl mx-auto">
                    A Full Stack Developer passionate about building scalable web applications with seamless frontend and backend integration. Skilled in React, Next.js, Node.js, and MongoDB, MySQL with a strong focus on problem-solving and performance optimization.
                </p>
